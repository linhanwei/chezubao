    ...
    <form method="post" id="auth_form" action="index.php?act=member_security&op=auth">
      ...
      <dl>
        ...
        <dd>
         ...
         <img src="<?php echo MALL_SITE_URL?>/index.php?act=seccode&op=makecode&hash=<?php echo getNchash();?>" name="codeimage" border="0" id="codeimage" class="ml5 vm"><a href="javascript:void(0)" class="ml5 blue" onclick="javascript:document.getElementById('codeimage').src='<?php echo MALL_SITE_URL?>/index.php?act=seccode&op=makecode&hash=<?php echo getNchash();?>&t=' + Math.random();">看不清？换张图</a>
