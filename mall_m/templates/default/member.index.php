...
<section class="member-sales-box">
    ...
    <section class="lyt-content">
        <div class="lyt-main">
            <div class="left">
                <a><img src="./templates/default/images/index/activity-img1.jpg"></a>
            </div>
            <div class="right">
                <div class="top">
                    <a><img src="./templates/default/images/index/activity-img2.jpg"></a>
                </div>
                <div class="bottom">
                    <div class="bottom-left">
                        <a><img src="./templates/default/images/index/activity-img3.jpg"></a>
                    </div>
                    <div class="bottom-right">
                        <a><img src="./templates/default/images/index/activity-img4.jpg"></a>
                    </div>
                </div>
            </div>
        </div>
