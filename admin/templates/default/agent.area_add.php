...
<div class="page">
  <div class="fixed-bar">
      <div class="item-title">
          <h3>战区</h3>
          <ul class="tab-base">
              <li><a href="index.php?act=agent&op=area"><span>战区管理</span></a></li>
              <li><a href="JavaScript:void(0);" class="current"><span><?php if($_GET['aa_id']) echo '编辑战区';else echo '添加战区';?></span></a></li>
          </ul>
      </div>
  </div>
    ...
    <form id="add_form" method="post">
        ...
        <table class="table tb-type2 nobdb">
            <tbody>
            <tr class="noborder">
                <td colspan="2" class="required"><label class="validation" for="aa_name">战区名称:</label></td>
            </tr>
            <tr class="noborder">
