...
<div class="page">
    <div class="fixed-bar">
        <div class="item-title">
            <h3>战区</h3>
            <ul class="tab-base">
                <li><a href="JavaScript:void(0);" class="current"><span>战区管理</span></a></li>
                <li><a href="index.php?act=agent&op=area_add"><span>添加战区</span></a></li>
            </ul>
        </div>
    </div>
                ...
                <?php foreach($output['area_list'] as $k => $v){ ?>
                    <tr class="hover">
                        ...
                        <td class="align-center w200">
                            ...
                            <a href="javascript:void(0)" onclick="if(confirm('确定删除战区?')){location.href='index.php?act=agent&op=area_del&aa_id=<?php echo $v['aa_id']; ?>'}">删除</a>
