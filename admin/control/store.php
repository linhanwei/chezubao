...
class storeControl extends SystemControl {
    ...
    public function store_editOp() {
        ...
        if (chksubmit()) {
            ...
            if ($_FILES['banner_1']['name'] != '') {
                $update_array['banner_1'] = $this->upload_banner_image('banner_1');
            }
            if ($_FILES['banner_2']['name'] != '') {
                $update_array['banner_2'] = $this->upload_banner_image('banner_2');
            }
            if ($_FILES['banner_3']['name'] != '') {
                $update_array['banner_3'] = $this->upload_banner_image('banner_3');
            }
            if ($_FILES['banner_4']['name'] != '') {
                $update_array['banner_4'] = $this->upload_banner_image('banner_4');
            }
            if ($_FILES['banner_5']['name'] != '') {
                $update_array['banner_5'] = $this->upload_banner_image('banner_5');
            }
    ...
    private function upload_banner_image($file) {
        $pic_name = '';
        $upload = new UploadFile();
        $uploaddir = ATTACH_PATH . DS . 'store_joinin' . DS;
        $upload->set('default_dir', $uploaddir);
