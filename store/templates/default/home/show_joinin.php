			  ...
			  <form id="login_form" action="index.php?act=login" method="post">
				...
				<dl>
				  ...
				  <dd>
					...
					<a href="JavaScript:void(0);" onclick="javascript:document.getElementById('codeimage').src='<?php echo STORE_SITE_URL?>/index.php?act=seccode&op=makecode&hash=<?php echo getNchash();?>&t=' + Math.random();" class="change" title="看不清，换一张">
					<img src="<?php echo STORE_SITE_URL?>/index.php?act=seccode&op=makecode&hash=<?php echo getNchash();?>" class="fl ml5" name="codeimage" id="codeimage" border="0"/></a>
					<label></label>
				  </dd>
				</dl>
				<?php } ?>
