      ...
      <form id="login_form" method="post" action="index.php?act=login&op=login"  class="bg">
        ...
        <dl>
          ...
          <dd style="min-height:54px;">
            ...
            <img src="<?php echo STORE_SITE_URL?>/index.php?act=seccode&op=makecode&hash=<?php echo getNchash();?>" name="codeimage" border="0" id="codeimage" class="fl ml5"> <a href="javascript:void(0)" class="ml5" onclick="javascript:document.getElementById('codeimage').src='<?php echo STORE_SITE_URL?>/index.php?act=seccode&op=makecode&hash=<?php echo getNchash();?>&t=' + Math.random();"><?php echo $lang['login_index_change_checkcode'];?></a>
            <label></label>
          </dd>
        </dl>
        <?php } ?>
